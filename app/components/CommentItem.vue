...
const canContinueThread = computed(() => {
  return displayDepth.value >= maxDepth && replyCount.value > 0
})
...
<template>
  <div
    ...
    :class="{
      'border-l-2 border-slate-700 pl-4': displayDepth > 0,
      'bg-blue-500/10 p-3 -mx-3 ring-1 ring-blue-500/30': isHighlightedTarget
    }"
  >
    <div class="flex gap-3">
      ...
      <div v-else class="flex-shrink-0">
        <div class="w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center text-slate-500 text-sm">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center gap-4 text-xs">
          ...
          >
            ...
            Continuar thread ({{ replyCount }} {{ replyCount === 1 ? 'resposta' : 'respostas' }})
          </button>
        </div>
