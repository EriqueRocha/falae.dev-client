...
<template>
  <article class="bg-slate-800 rounded-xl p-3 border border-slate-700/50 hover:border-blue-500/60 hover:shadow-xl hover:shadow-black/40 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer max-h-[450px] overflow-hidden">
      ...
      <div class="flex-1 min-w-0 flex flex-col">
        ...
        <div class="flex items-center gap-3 text-sm flex-shrink-0">
          <span
            ...
            :class="comment.isLiked ? 'text-green-400' : 'text-slate-400'"
          >
          ...
          <span
            class="flex items-center gap-1 transition-colors"
            :class="comment.isDisliked ? 'text-red-400' : 'text-slate-400'"
          >
